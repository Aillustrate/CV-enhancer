...
class CVEnhancer:
    ...
    def make_prompt(self, cv_path, job_path):
        ...
        return self.TEMPLATE.format(system_prompt=self.system_prompt, user_message=user_prompt,
    ...
    def save_report(self, llm_output, cv_path, job_path, **generation_kwargs):
        ...
        new_report = {'cv': cv_path, 'job': job_path, 'system_prompt': self.system_prompt, **generation_kwargs,
                      'model': MODEL_NAME, 'output': llm_output}
        report_id = make_id()
