...
class Evaluator:
    def __init__(self, report_path='evaluation/report.json', eval_dir='evaluation/results',
                 guidelines_path='evaluation/guidelines.json', urls_path='evaluation/urls.json', shuffle=True):
